...
# SUPG/PSPG/LSIC stabilization, Crank-Nicolson, SNES + LSC Schur fieldsplit preconditioner.
...
class Solver(SolverBase):
    ...
    def __init__(
        ...
        if p_inlet is None or p_outlet is None:
            raise ValueError(
                "p_inlet and p_outlet are required for stabilized_lsc_pressurebc. "
    ...
    def setup(
        ...
        # 6. SNES + LSC Schur fieldsplit (identical structure to stabilized_lsc.py)
