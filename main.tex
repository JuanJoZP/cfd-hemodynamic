...
\begin{figure}[htbp]
  ...
  \caption{Convergencia de malla para el benchmark de la \cref{sec:ldc}: norma $L^2$ de la velocidad (izquierda) y de la presión (derecha) en función de la resolución de malla $N$.}
...
\begin{figure}[htbp]
  ...
  \caption{Componente $x$ de la velocidad en la recta $x=0.5$ para el benchmark de la \cref{sec:ldc} con $N=100$, frente a los datos de \cite{ghia_high-re_1982}.}
...
\begin{figure}[htbp]
  ...
  \caption{Líneas de corriente para el benchmark de la \cref{sec:ldc}: simulación con $N=100$ (izquierda) y referencia de \cite{ghia_high-re_1982} (derecha).}
