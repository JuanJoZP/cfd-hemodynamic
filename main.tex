...
Se obtuvo convergencia en ambas variables; el cambio entre la norma $L^2$ tanto para el campo de velocidades como para el de presiones entre las dos últimas simulaciones fue menor al $2\%$. Este comportamiento permite asegurar que la resolución espacial es adecuada para capturar los gradientes del flujo.
...
Por el contrario, en los escenarios de severidad alta ($\eta = 0.75$), el desarrollo del flujo es altamente inestable, inicialmente. Independientemente de la pendiente, durante los primeros instantes de la simulación se observa una perturbación que se propaga axialmente como una onda. Esta estructura presenta un núcleo central de flujo laminar, con unos vórtices que viajan junto a la onda a lo largo de la arteria (\cref{fig:flujo_alto_transiente}).
...
Por otro lado, la distribución de presiones en el árbol microvascular (\cref{fig:presion_arbol}) muestra un rango de variación muy reducido, con valores que oscilan apenas entre $43.41$ y $43.98\,\mathrm{mmHg}$. Se observan en cada bifurcación, incrementos localizados de presión en la pared que se enfrenta directamente al flujo del vaso precedente.
