...
en arbol:
- visual de las zonas de recirculacion del arbol micro /velocidad
-visual de presion
- visual de wss
...
En la porción correspondiente al árbol microvascular explícito, el flujo se caracteriza por una distribución simétrica que sigue la jerarquía de bifurcaciones. Sin embargo, en las regiones de unión (axilas de las bifurcaciones), se observa la generación de pequeños vórtices locales debido a la deflexión del flujo hacia las ramas hijas. Este fenómeno es proporcional al número de Reynolds local, tendiendo a desaparecer en las generaciones más distales donde el régimen es puramente viscoso.
