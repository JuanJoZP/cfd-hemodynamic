...
Para $Re=10000$, los resultados numéricos obtenidos con el solver desarrollado se presentan en las \cref{fig:ldc_streamlines_re10000,fig:ldc_lineplot_re10000}. En la \cref{fig:ldc_streamlines_re10000} se comparan los mapas de líneas de corriente del flujo en la cavidad: a la izquierda se muestra el campo computado con el solver presente y a la derecha el correspondiente resultado de referencia reportado por Ghia et al. \cite{ghia_high-re_1982}. La \cref{fig:ldc_lineplot_re10000} muestra la comparación del perfil de la componente $x$ de la velocidad a lo largo de la recta $x=0.5$ frente a los datos de Ghia et al. \cite{ghia_high-re_1982}.

\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.75\textwidth]{figures/lid_driven_streamlines.png}
  \caption{Comparación con el benchmark de cavidad inducida por tapa ($Re=10000$): mapas de líneas de corriente (izquierda: solver presente; derecha: Ghia et al. \cite{ghia_high-re_1982}).}
  \label{fig:ldc_streamlines_re10000}
\end{figure}

\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.55\textwidth]{figures/lidriven_lineplot.png}
  \caption{Benchmark de cavidad inducida por tapa ($Re=10000$): comparación de la componente $x$ de la velocidad a lo largo de la recta $x=0.5$ frente a los datos de Ghia et al. \cite{ghia_high-re_1982}.}
  \label{fig:ldc_lineplot_re10000}
\end{figure}
...
\begin{figure}[!ht]
  ...
  \caption{Comparación del mismo árbol microvascular sin engrosamiento (izquierda) y con engrosamiento (derecha). Parámetro usado: $f_{\mathrm{thick}}=\,$\textit{[por definir]} y $L_{\mathrm{th}}=\,$\textit{[por definir]}.}
...
\begin{figure}[!ht]
  ...
  \caption{Comparación del mismo árbol microvascular sin rarefacción (izquierda) y con rarefacción (derecha). Parámetro usado: factor de rarefacción $=\,$\textit{[por definir]}.}
...
\begin{description}
  ...
  \begin{itemize}
    ...
    \item \texttt{lumen\_thickening\_factor} [adimensional]: Factor multiplicativo aplicado al radio de los vasos distales para simular el engrosamiento de la pared microvascular en la DMV. Valor $= 1$ implica sin engrosamiento.
...
\section{Resultados}
Reporte de hallazgos sin interpretaciones.

\begin{itemize}
  \item resultados de la validacion?
