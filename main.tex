...
La \cref{fig:ldc_lineplot_re1000} muestra la comparación del perfil de la componente $x$ de la velocidad a lo largo de la recta $x=0.5$ utilizando diferentes esquemas numéricos, frente a los datos de referencia reportados por Ghia et al. \cite{ghia_high-re_1982} para $Re=1000$.

% \begin{figure}[htbp]
%   \centering
%   \includegraphics[width=0.6\textwidth]{figures/template_lidriven_lineplot_solvers.png}
%   \caption{Benchmark de cavidad inducida por tapa ($Re=1000$): comparación de la componente $x$ de la velocidad en la recta $x=0.5$ para los distintos solvers configurados, frente a los datos de Ghia et al. \cite{ghia_high-re_1982}.}
%   \label{fig:ldc_lineplot_re1000}
% \end{figure}

% Adicionalmente, en la \cref{fig:ldc_streamlines_re1000} se contrastan cualitativamente los mapas de líneas de corriente desarrollados en la cavidad.

% \begin{figure}[htbp]
%   \centering
%   \includegraphics[width=0.8\textwidth]{figures/template_lid_driven_streamlines.png}
%   \caption{Mapas de líneas de corriente en la cavidad inducida por tapa ($Re=10000$): (Izquierda) Resultados del solver implementado; (Derecha) Referencia de Ghia et al. \cite{ghia_high-re_1982}.}
%   \label{fig:ldc_streamlines_re10000}
% \end{figure}
